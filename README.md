...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   A: If a Route doesn't have a path, useRouteMatch is returned and uses the closest parent match

2. How would you explain form validation to someone who has never programmed before?
   A: Simply put, form validation checks that the required information is where it's suppose to be.

3. In 1-2 sentences, define end to end testing.
   A: End to end testing tests everything from top to bottom by simulating a real user scenario. E2E testing is the most comprehensive form of testing.
